...
//attribution d'un poids pour la distance
...
//définition de la distance cluster
    public void setDistance(Distance distance) {
        this.distance = distance;
    }
//définition du sous cluster
...
//attribution d'un nom de cluster
...
//ajout d'un sous cluster
    public void addChild(Cluster cluster) {
        getChildren().add(cluster);

    }
//sous clusters contenus par le clusters
    ...
    public double getTotalDistance() {
        ...
        if (getChildren().size() > 0) {
            dist += children.get(0).getTotalDistance();// ajout des distances des sous clustres
        }
        return dist;
